...
class FormularioNotaFragment : Fragment() {
    ...
    private val notaData by lazy { NotaData() }
    private val binding by lazy { FormularioNotaBinding.inflate(layoutInflater) }
    ...
    override fun onCreateView(
        ...
        binding.nota = notaData
        binding.lifecycleOwner = this
        binding.setSolicitaImagem { solicitaImagem() }
        return binding.root
    }
    ...
    private fun solicitaImagem() {
        ...
        CarregaImagemDialog().mostra(requireContext(), urlAtual) { urlNova ->
            this.notaData.imagemUrl.value = urlNova
        }
    }
