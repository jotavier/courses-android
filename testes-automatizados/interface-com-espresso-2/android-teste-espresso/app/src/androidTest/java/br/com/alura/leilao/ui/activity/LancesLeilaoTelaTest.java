...
public class LancesLeilaoTelaTest extends BaseTesteIntegracao {
    ...
    public void deve_AtualizarLancesDoLeilao_QuandoReceberUmLance() throws IOException {
        /*
         *        MAPEAMENTO DE FLUXO
         * 1. Salvar leilão na API
         * 2. Inicializar MainActivity
         * 3. Clica no leilão
         * 4. Clica no fab da tela da lances do leilão
         * 5. Verifica se aparecer dialog de aviso por não ter usuário com título e mensagem
         * esperada
         * 6. Clica no botão cadastrar usuário
         * 7. Clica no fab tela de lista de usuários
         * 8. Clica no EditText e preenche com o nome do usuário
         * 9. Clica em Adicionar
         * 10. Clica no back do Android
         * 11. Propõe um lance
         * 12. Fazer assertion para as views de maior e menor lance, e també, para os maiores lances
         * */
