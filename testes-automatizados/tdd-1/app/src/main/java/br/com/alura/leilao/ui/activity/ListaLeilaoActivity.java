...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("João"), 1000.0));

        Leilao carro = new Leilao("Carro");
        console.propoe(new Lance(new Usuario("Joana"), 10000.0));
        console.propoe(new Lance(new Usuario("Maria"), 15000.0));
        console.propoe(new Lance(new Usuario("Ana"), 17000.0));
